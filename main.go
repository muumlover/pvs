...
func main() {
	host := flag.String("H", "", "set `host` as ip:port")
	username := flag.String("u", "", "set `username` for ssh")
	password := flag.String("p", "", "set `password` for ssh")
	flag.Parse()
